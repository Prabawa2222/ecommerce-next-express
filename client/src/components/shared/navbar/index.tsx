...
export default function Navbar() {
  ...
  return (
    <div className={cn("sticky top-0 w-full z-50", isHomePage && "fixed")}>
      <nav
        className={cn(
          "relative transition-all ease-out hover:bg-brand-black-900 border-b-[0.5px] border-zinc-900",
          isHomePage &&
            isScrolledDown &&
            "bg-brand-black-900 duration-4000 border-opacity-100",
          isHomePage &&
            !isScrolledDown &&
            "bg-transparent duration-300 border-opacity-0",
          !isHomePage &&
            "bg-brand-black-900 border-b-[0.5px] border-opacity-100"
        )}
        style={{}}
      >
        {/* Logo */}
